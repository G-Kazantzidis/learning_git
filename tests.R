...
#### even_odd #
# This function determines whether a number is even or odd. Also works with vectors
...
#### all_fac #
# This function finds all the factors of a number. Returns both negative and positive factors 
...
#### my.lm # 
# This function takes a data.frame with variables x and y, estimates the linear regression model
...
#### my.test #
# This function calculates the mean difference between two variables x and y from a training set and uses this mean difference
